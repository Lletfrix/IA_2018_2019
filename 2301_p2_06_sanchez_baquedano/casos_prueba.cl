...
(defparameter *estimate-new*
  '((Calais (0.0 0.0)) (Reims (25.0 25.0)) (Paris (30.0 30.0))
    (Nancy (50.0 50.0)) (Orleans (55.0 55.0)) (St-Malo (65.0 65.0))
    (Nantes (75.0 75.0)) (Brest (90.0 90.0)) (Nevers (70.0 70.0))
    (Limoges (100.0 100.0)) (Roenne (85.0 85.0)) (Lyon (105.0 105.0))
    (Toulouse (130.0 130.0)) (Avignon (135.0 135.0)) (Marseille (145.0 145.0))))
